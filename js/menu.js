...
for (var i = 0; i < btns.length; i++) {
  btns[i].addEventListener("click", function() {
    alert("ddd");
  var current = $(this);
  $(".navigation__mega-menu__btn").addClass(" navigation__mega-menu__inActive");
  current.removeClass(" navigation__mega-menu__inActive").addClass(" navigation__mega-menu__active");
  });
  
}

$( ".navigation__mega-menu__content__back" ).on( "click", function() {
  alert("aaa");
  $(".navigation__mega-menu__btn").removeClass(" navigation__mega-menu__inActive");
...
$(function(){
  ...
  var moveMenu = 200;
   $(window).scroll(function() {
     var scroll = getCurrentScroll();
       if ( scroll >= moveMenu ) {
            $('.navigation__button').addClass('move');
         }
         else {
             $('.navigation__button').removeClass('move');
         }
   });
